...
class PlaylistTrackItemAdapter : RecyclerView.Adapter<PlaylistTrackItemAdapter.PlaylistTrackItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PlaylistTrackItemViewHolder, position: Int) {
        ...
        holder.trackDuration.text = trackItems[position].duration
